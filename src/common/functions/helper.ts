...
import { libelleMailSenderIfSucces, moreInfoMailSenderIfSucces, titleMailSenderIfSucces } from './translate';
...
export const messageSuccessInvestment = (info:{language:string, subregion:string, percentageWithdraw:number, amountInvest:number, nameStructure:string, times: number, commissionTotal:number}):string => {
    return `
    <!DOCTYPE html>
