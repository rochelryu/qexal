export const moreInfoMailSenderIfSucces = (info:{language:string, subregion:string, percentageWithdraw:number, amountInvest:number}): string => {
...
export const libelleMailSenderIfSucces = (info:{language:string, nameStructure:string, times: number}): string => {
    if (info.language === 'French') {
